...
#DAnalysis
DANALYSISPATH=/afs/cern.ch/user/j/jkiesele/public/DAnalysis_framework/YR_Delphes/DAnalysis
...
export LD_LIBRARY_PATH=/afs/cern.ch/user/c/cprieels/DAnalysis:$LD_LIBRARY_PATH
export PATH=/afs/cern.ch/user/c/cprieels/DAnalysis:$PATH
